    ...
    <div class="form-wrapper">
        ...
        <div class="form-fields">
          <div class="field-row">
            ...
            <input
              ...
              placeholder="请输入用户名"
            />
            <span v-if="usernameField.error.value" class="error">{{
          ...
          <div class="field-row">
            ...
            <input
              ...
              placeholder="请输入邮箱"
            />
            <span v-if="emailField.error.value" class="error">{{
          ...
          <div class="field-row">
            ...
            <input
              ...
              @input="
                (e) => ageField.setValue(Number((e.target as HTMLInputElement).value))
              "
              type="number"
            />
          </div>
      ...
      <div class="section">
        ...
        <div class="watch-info">
          ...
          <p>
            <strong>是否有字段被修改:</strong> {{ form.isFieldsTouched() ? "是" : "否" }}
          </p>
          <p>
            <strong>被修改的字段:</strong>
            {{ form.getTouchedFields().join(", ") || "无" }}
          </p>
        </div>
      </div>

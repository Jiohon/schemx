...
/**
 * UploadRenderer - 使用 createRenderWrapper 工厂函数创建的上传渲染器
 *
 * 通过 createRenderWrapper 包装 UploadRendererComponent，提供：
 ...
 */
// 导出原始组件（用于向后兼容）
export { UploadRendererComponent }

// 默认导出原始组件以保持向后兼容性
export default UploadRendererComponent

// 导出包装后的渲染器（用于 RendererRegistry 注册）
export const UploadRendererWrapped = createRenderWrapper({
  component: UploadRendererComponent,
})

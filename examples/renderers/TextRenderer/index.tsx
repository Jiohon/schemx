...
/**
 * TextRenderer - 使用 createRenderWrapper 工厂函数创建的文本渲染器
 *
 * 通过 createRenderWrapper 包装 TextRendererComponent，提供：
...
export const TextRendererWrapped = createRenderWrapper({

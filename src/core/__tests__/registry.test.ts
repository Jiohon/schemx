 ...
 *
 * @module core/__tests__/registry
 */
...
import { createLocalRegistry, Registry } from "../registry"
...
describe("Registry", () => {
  ...
  describe("createLocalRegistry 工厂函数", () => {
    it("创建独立的 Registry 实例", () => {
      const reg = createLocalRegistry("number")

...
import type { CheckboxProps } from "@wot-ui/ui/components/wd-checkbox/types"
import type { CheckboxGroupProps } from "@wot-ui/ui/components/wd-checkbox-group/types"

import type { SchemxBaseComponentProps } from "@schemx/vue"

export type CheckboxOptionValue = CheckboxProps["name"]
export type CheckboxValue = CheckboxGroupProps["modelValue"] | string
...
export interface CheckboxRendererProps
  extends
    ...
    /* @vue-ignore */
    Partial<
      Omit<CheckboxGroupProps, "modelValue" | "onUpdate:modelValue" | "onChange">
    > {
  /** 当前值（数组形式） */
  value?: CheckboxValue
  /** 值变化回调 */

 ...
 */
export function useWatch<T extends FormValues>(
  nameOrNamesOrCallback: NamePath<T> | NamePath<T>[] | GlobalCallback<T>,
  callbackOrOptions?: SingleFieldCallback<T> | MultiFieldCallback<T> | useWatchOptions,
 ...
 * ```
 */
export function useWatchField<T extends FormValues>(
  name: NamePath,
  callback: SingleFieldCallback<T>,
  options?: useWatchOptions
): () => void {
 ...
 * ```
 */
export function useWatchAll<T extends FormValues>(
  callback: GlobalCallback<T>,
  options?: useWatchOptions
): () => void {

 ...
 * @example
 * ```typescript
 * import { rendererRegistry } from '@jonhn/schema-form-core'
 *
 * // 注册全局渲染器
 ...
 * @example
 * ```typescript
 * import { defineRenderer } from '@jonhn/schema-form-core'
 *
 ...
 * ```
 */
export function defineRenderer<T extends Component>(type: string, renderer: T): T {
 ...
 * ```
 */
export function defineRenderers<T extends RendererMap>(renderers: T): T {

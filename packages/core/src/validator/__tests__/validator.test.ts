 ...
 * registerRules、unregisterRules、getFieldError、setFieldError、
...
import { createValidator, Validator } from ".."
...
describe("Validator", () => {
  ...
  describe("getFieldError / setFieldError / resetErrors", () => {
    ...
    it("reset 清空所有错误", () => {
      const v = new Validator<TestForm>()
      v.registerRules("name", createMinLengthSchema(1, "err"))
      v.registerRules("email", createMinLengthSchema(1, "err"))
